...
return [
    ...
    'password' => [
        'letters' => ':attribute باید شامل حداقل یک کاراکتر باشد',
        'mixed' => ':attribute باید شامل حداقل یک کاراکتر بزرگ و یک کاراکتر کوچک باشد',
        'numbers' => ':attribute باید شامل حداقل یک عدد باشد',
        'symbols' => ':attribute باید شامل حداقل یک سیمبول باشد',
        'uncompromised' => ':attribute وارد شده امن نمی باشد لطفا دوباره تلاش کنید',
    ],
