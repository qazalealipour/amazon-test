...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن پیج</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.content.pages.store') }}" method="post">
            @csrf
