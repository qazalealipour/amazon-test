    ...
    <div class="card">
        <div class="card-header align-items-center py-5 gap-5">
            ...
            <div class="d-flex align-items-center">
                <a href="{{ route('admin.content.comments.index') }}" class="btn btn-primary">بازگشت</a>
            </div>
        </div>
        <div class="card-body">
            ...
            @if ($comment->parent_id === null)
                ...
                <form id="form" class="form" action="{{ route('admin.content.comments.answer', [$comment->id]) }}" method="post">
                    @csrf
                    <div class="row mb-8">
