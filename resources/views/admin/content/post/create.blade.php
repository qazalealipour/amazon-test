...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن پست</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.content.posts.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <textarea name="summary" class="form-control form-control-solid h-100px">{{ old('summary') }}</textarea>
                        @error('summary')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                        ...
                        <div class="w-100">
                            <select class="form-select form-select-solid" name="category_id" data-control="select2"
                                ...
                                @foreach ($postCategories as $postCategory)
                                    <option value="{{ $postCategory->id }}" @selected(old('category_id') == $postCategory->id)>{{ $postCategory->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('category_id')
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <input class="form-control form-control-solid ps-12" placeholder="انتخاب تاریخ" id="published_at_view" type="text" value="{{ old('published_at') }}">
                        </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <textarea name="body" id="editor" class="form-control form-control-solid h-100px">{{ old('body') }}</textarea>
                        @error('body')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
