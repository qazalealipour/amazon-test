...
@section('page-title', 'ویرایش سوال')
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.content.faqs.update', [$faq->id]) }}" method="post">
            @csrf
            @method('put')
            <div class="card-body p-9">
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="question" value="{{ old('question', $faq->question) }}" />
                        @error('question')
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="hidden" id="tags" class="form-control form-control-solid" name="tags" value="{{ old('tags', $faq->tags) }}" />
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <textarea name="answer" id="editor" class="form-control form-control-solid h-100px">{{ old('answer', $faq->answer) }}</textarea>
                        @error('answer')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
