...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن منو</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.content.menus.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-xl-9 fv-row">
                        <div class="w-100">
                            <select class="form-select form-select-solid" name="parent_id" data-control="select2"
                                ...
                                <option value="" @selected(old('parent_id') == null)>والد</option>
