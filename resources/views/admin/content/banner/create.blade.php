...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن بنر</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.content.banners.store') }}" method="post" enctype="multipart/form-data">
            @csrf
