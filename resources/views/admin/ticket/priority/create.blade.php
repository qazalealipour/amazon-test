...
@section('title', 'افزودن اولویت')

@section('page-title', 'افزودن اولویت')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن اولویت</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.tickets.priorities.store') }}" method="post">
            @csrf
