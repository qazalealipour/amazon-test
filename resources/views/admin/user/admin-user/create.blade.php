...
@section('title', 'افزودن کاربر ادمین')

@section('page-title', 'افزودن کاربر ادمین')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن کاربر ادمین</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.users.admin-users.store') }}" enctype="multipart/form-data" method="post">
            @csrf
