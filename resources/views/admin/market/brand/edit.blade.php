...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">ویرایش برند</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.market.brands.update', [$brand->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-body p-9">
                <div class="row mb-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('admin-assets/media/svg/files/blank-image.svg') }})">
                            <div class="image-input-wrapper w-150px h-150px bgi-position-center" style="background-size: 100%; background-image: url({{ asset(Illuminate\Support\Str::replace('\\', '/', $brand->logo_path)) }})"></div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="persian_name" value="{{ old('persian_name', $brand->persian_name) }}" />
                        @error('persian_name')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="original_name" value="{{ old('original_name', $brand->original_name) }}" />
                        @error('original_name')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="hidden" id="tags" class="form-control form-control-solid" name="tags" value="{{ old('tags', $brand->tags) }}" />
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <textarea name="description" id="editor" class="form-control form-control-solid h-100px">{{ old('description', $brand->description) }}</textarea>
                        @error('description')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
