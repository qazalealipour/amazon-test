...
@section('title', 'افزودن گارانتی کالا')

@section('page-title', 'افزودن گارانتی کالا')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">گارانتی</li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-300 w-5px h-2px"></span>
    </li>
    <li class="breadcrumb-item text-dark">افزودن گارانتی کالا</li>
@endpush

@section('content')
    <div class="card">
        <div class="card-header">
            <div class="card-title fs-3 fw-bolder">مشخصات گارانتی کالا</div>
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <a href="{{ route('admin.market.products.guarantees.index', [$product->id]) }}" class="btn btn-primary">بازگشت</a>
            </div>
        </div>
        <form id="form" class="form" action="{{ route('admin.market.products.guarantees.store', [$product->id]) }}" method="post">
            @csrf
            <div class="card-body p-9">
                <div class="row mb-8">
                    <div class="col-xl-3 text-md-end">
                        <div class="fs-6 fw-bold mt-2 mb-3">عنوان گارانتی</div>
                    </div>
