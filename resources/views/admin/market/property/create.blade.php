...
@section('title', 'افزودن فرم')

@section('page-title', 'افزودن فرم')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن فرم</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.market.properties.store') }}" method="post">
            @csrf
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="unit" value="{{ old('unit') }}" />
                        @error('unit')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
