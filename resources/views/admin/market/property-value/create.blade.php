...
@section('title', 'افزودن مقدار فرم')

@section('page-title', 'افزودن مقدار فرم')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن مقدار فرم</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form" action="{{ route('admin.market.properties.values.store', [$property->id]) }}" method="post">
            @csrf
            <div class="card-body p-9">
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="value" value="{{ old('value') }}" />
                        @error('value')
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="price_increase" value="{{ old('price_increase') }}" />
