...
@section('title', 'لیست تخفیف های عمومی')

@section('page-title', 'لیست تخفیف های عمومی')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">تخفیف های عمومی</li>
@endpush
    ...
    <div class="card card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <a href="{{ route('admin.market.discounts.common-discounts.create') }}" class="btn btn-primary">افزودن تخفیف عمومی</a>
            </div>
        </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                        <thead>
                            <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">درصد تخفیف</th>
                                <th class="min-w-150px">سقف تخفیف</th>
                                <th class="min-w-150px">عنوان مناسبت</th>
                        ...
                        <tbody class="fw-bold text-gray-600 text-center">
                            @foreach ($commonDiscounts as $commonDiscount)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.market.discounts.common-discounts.edit', [$commonDiscount->id]) }}" class="btn btn-icon btn-bg-light btn-active-light-primary w-30px h-30px me-3">
                                        ...
                                        <form action="{{ route('admin.market.discounts.common-discounts.destroy', [$commonDiscount->id]) }}" method="post" class="d-inline">
                                            @csrf
                                            @method('delete')
