...
@section('page-title', 'افزودن کالا')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن کالا</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.market.products.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="weight" value="{{ old('weight') }}" />
                        @error('weight')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="length" value="{{ old('length') }}" />
                        @error('length')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="width" value="{{ old('width') }}" />
                        @error('width')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="height" value="{{ old('height') }}" />
                        @error('height')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                        ...
                        <div class="w-100">
                            <select class="form-select form-select-solid" name="brand_id" data-control="select2"
                                ...
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}" @selected(old('brand_id') == $brand->id)>{{ $brand->original_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('brand_id')
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-4">
                        <input type="text" class="form-control form-control-solid" name="meta_key[]" placeholder="ویژگی" />
                        @error('meta_key.*')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
                    ...
                    <div class="col-xl-4">
                        <input type="text" class="form-control form-control-solid" name="meta_value[]" placeholder="مقدار" />
                        @error('meta_value.*')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
