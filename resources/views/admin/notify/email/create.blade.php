...
@section('title', 'افزودن اطلاعیه ایمیلی')
...
@section('page-title', 'افزودن اطلاعیه ایمیلی')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن اطلاعیه ایمیلی</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.notify.email.store') }}" method="post">
            @csrf
            <div class="card-body p-9">
                <div class="row mb-8">
                    <div class="col-xl-3 text-md-end">
                        <div class="fs-6 fw-bold mt-2 mb-3">عنوان ایمیل</div>
                    </div>
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="subject" value="{{ old('subject') }}" />
                        @error('subject')
