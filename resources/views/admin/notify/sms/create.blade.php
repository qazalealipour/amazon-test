...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن اطلاعیه پیامکی</li>
@endpush
...
@section('content')
    <div class="card">
        ...
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.notify.sms.store') }}" method="post">
            @csrf
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <textarea name="body" class="form-control form-control-solid h-100px">{{ old('body') }}</textarea>
                        @error('body')
                            <div class="fv-plugins-message-container invalid-feedback">
                                <div class="badge badge-light-danger">{{ $message }}</div>
                            </div>
