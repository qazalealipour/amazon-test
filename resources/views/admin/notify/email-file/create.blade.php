...
@section('page-title', 'افزودن فایل')
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-dark">افزودن فایل</li>
@endpush
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <a href="{{ route('admin.notify.email-files.index', [$email->id]) }}" class="btn btn-primary">بازگشت</a>
            </div>
        </div>
        <form id="form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            action="{{ route('admin.notify.email-files.store', [$email->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-xl-9 fv-row">
                        <div class="d-flex mt-3">
                            <div class="form-check form-check-custom form-check-solid me-5">
                                <input class="form-check-input" type="radio" value="public" name="storage_location" id="category_product_count_yes" @checked(old('storage_location') == 'public') checked>
                                <label class="form-check-label" for="category_product_count_yes">عمومی</label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" value="storage" name="storage_location" id="category_product_count_no" @checked(old('storage_location') == 'storage')>
